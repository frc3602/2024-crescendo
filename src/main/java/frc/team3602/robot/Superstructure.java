...
public class Superstructure {
  ...
  public Command inFrameCmd() {
    ...
    //Created by Abe @10:01 4/4
    public Command autonCaShootCmd() {
      return Commands.sequence(
         Commands.print("bruhfirstAutonAimSpeakerCmd"),
            driveSubsys.turnTowardSpeaker().withTimeout(2),
          Commands.print("secondAutonAimSpeakerCmd"),
          Commands.parallel(
             driveSubsys.stopDriveCmd(),
          Commands.print("thirdAutonAimSpeakerCmd"),
     ...
     public Command autonBRUHShootCmd() {
    return Commands.sequence(
           
         shooterSubsys.runShooterSpeed(0.8, 0.8).withTimeout(0.2), //.5>.65

        Commands.print("bruhfirstAutonAimSpeakerCmd"),
            driveSubsys.turnTowardSpeaker().withTimeout(1),
          Commands.print("secondAutonAimSpeakerCmd"),
  ...
  //      public Command autonClockwiseShootCmd() {
  //   return Commands.sequence(
           
  //       Commands.print("bruhfirstAutonAimSpeakerCmd"),
  //           driveSubsys.turnClockwiseTowardSpeaker().withTimeout(1),
  //         Commands.print("secondAutonAimSpeakerCmd"),
  ...
  // }
    ...
    return Commands.sequence(
        ...
        !pivotSubsys.isAtPosition ? pivotSubsys.runSetAngle(() -> 49).until(() -> pivotSubsys.isAtPosition)
            : pivotSubsys.runOnce(() -> {
            }),
...
Commands.sequence(
  ...
  //       Commands.print("firstAutonAimSpeakerCmd"),
  //           driveSubsys.turnTowardSpeaker().until(() -> driveSubsys.pointToSpeaker()),
  //            driveSubsys.stopDriveCmd(),
...
public Command autonCloseSourceShootCmd() {
  ...
  // return Commands.sequence(
  // Commands.parallel(
  // shooterSubsys.runShooterSpeed(0.55, 0.55).until(() ->
  // shooterSubsys.isAtVelocity),//velocity .8>.7>.6>.55
  // pivotSubsys.runSetAngle(() -> 21).until(() -> pivotSubsys.encoderValue <=
  // 22),
  // intakeSubsys.stopIntake()),
  ...
  // }
    ...
    // !pivotSubsys.isAtPosition ? pivotSubsys.runSetAngle(() -> 14).until (() ->
    // pivotSubsys.isAtPosition): pivotSubsys.runOnce(() -> {})) ;
  ...
  // //!pivotSubsys.isAtPosition ? pivotSubsys.runSetAngle(() -> 39).until (() ->
  // pivotSubsys.isAtPosition): pivotSubsys.runOnce(() -> {}),
  // pivotSubsys.stopMotors(),
  // shooterSubsys.runShooterSpeed(0.65, 0.65).until(() -> shooterSubsys.topOut >=
  // 0.55), //speed .8>.65 topout .65>.55
